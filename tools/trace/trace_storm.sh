...
echo "frame combo B_state B_atk B_animval B_animtimer B_actflags B_point B_air p2_state p2_hitstop p2_air C_state C_atk"
...
while :; do
  ...
  line="$f"; for k in combo B_state B_atk; do rd ${A[$k]}; line="$line $RDV"; done
  rd 0x2C268FCC 2; line="$line $RDV"; rd 0x2C268EA4 2; line="$line $RDV"; rd 0x2C268E8E 1; line="$line $RDV"
  for k in B_point B_air p2_state p2_hitstop p2_air C_state C_atk; do rd ${A[$k]}; line="$line $RDV"; done
  echo "$line"
